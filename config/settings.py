...
AUTHENTICATION_BACKENDS = [
    'users.backends.EmailAuthBackend',  # наш кастомный бэкенд (по email)
    'django.contrib.auth.backends.ModelBackend',  # стандартный (по username) — оставляем на всякий случай
]
